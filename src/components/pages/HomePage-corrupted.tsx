import { Search, TrendingUp, Award, Users, ArrowRight } from "lucide-react";port { Search, TrendingUp, Award, Users, ArrowRight } from "lucide-react";mport { Search, TrendingUp, Award, Users, ArrowRight } from "lucide-react";port { Search, TrendingUp, Award, Users, ArrowRight } from "lucide-react";port { TrendingUp, Award, Users, ArrowRight } from \"lucide-react\";import { DigitalKey } from \"../icons/KeyIcons\";port { TrendingUp, Award, Users, ArrowRight } from "lucide-react";
import { DigitalKey } from "../icons/KeyIcons";mport { TrendingUp, Award, Users, ArrowRight } from \"lucide-react\";\nimport { DigitalKey } from \"../icons/KeyIcons\";mport { Search, TrendingUp, Award, Users, ArrowRight } from "lucide-react";
              ...
              <div className="bg-transparent backdrop-blur-sm p-3 rounded-2xl shadow-lg border-2 border-white/30">
                <form onSubmit={handleSearch} className="flex gap-3">
                  <div className="flex-1 relative">
                    <DigitalKey className="absolute left-3 top-1/2 transform -translate-y-1/2 text-primary-foreground/70 h-4 w-4" />
                    <Input
            ...
            <Card className="group hover-lift border-0 modern-shadow bg-white/80 backdrop-blur-sm relative overflow-hidden">
              ...
              <CardContent className="relative p-10 text-center">
                <div className="flex h-20 w-20 items-center justify-center rounded-3xl bg-primary/10 mx-auto mb-8 group-hover:scale-110 transition-transform duration-300">
                  <DigitalKey className="h-10 w-10 text-primary" />
                </div>
        ...
        <div className="container relative">
          <div className="text-center-section text-primary-foreground">
            ...
            <div className="btn-group">
              ...
              >
                <DigitalKey className="mr-3 h-6 w-6" />
                Explore Properties
              </Button>
              <Button 
                size="lg" 
